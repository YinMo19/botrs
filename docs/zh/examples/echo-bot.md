...
如果想把原消息作为引用块而不是普通 @，用 `MessageParams` 加 `message_reference`；参见[文本消息](./text-messages.md) 与 [`examples/guild/reply_reference.rs`](https://github.com/YinMo19/botrs/blob/main/examples/guild/reply_reference.rs)。

## 参见

- 指南：[`docs/zh/guide/messages.md`](../guide/messages.md)
- 示例：[`examples/guild/reply_text.rs`](https://github.com/YinMo19/botrs/blob/main/examples/guild/reply_text.rs)
- 运行：`cargo run --example guild_reply_text --features examples`
