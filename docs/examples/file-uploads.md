...
- **Group / C2C rich media** — upload a URL via the reply session's `post_file`, then send the returned `Media` with `send_media_message`. See [`examples/group/reply_file.rs`](https://github.com/YinMo19/botrs/blob/main/examples/group/reply_file.rs) and [`examples/c2c/reply_file.rs`](https://github.com/YinMo19/botrs/blob/main/examples/c2c/reply_file.rs).
